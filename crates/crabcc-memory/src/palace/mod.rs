...
pub use path::{find_git_root, resolve_db_path};
pub use registry::{
    PalaceRegistry, DEFAULT_PALACE_CACHE_CAPACITY, GIT_ROOT_CACHE_TTL, PALACE_CACHE_TTI,
};
...
use path::migrate_legacy_if_needed;
use rrf::rrf_fuse;
...
#[cfg(test)]
mod tests {
    use super::path::{repo_storage_key, sanitize_slug};
    use super::rrf::{rrf_fuse, RRF_K};
    use super::*;
