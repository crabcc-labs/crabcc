...
mod tests {
    ...
    fn parse_and_sanitize_survive_adversarial_input() {
        ...
        let cases: &[&[u8]] = &[
            ...
            &[
                0x2a, 0x3a, 0x2a, 0x2a, 0x3a, 0x2a, 0x8d, 0x0a, 0x3d, 0x0a, 0x3d, 0x0a, 0x8d,
                0x8d, 0x0a, 0x3d, 0x0a, 0x3d, 0x0a, 0x8d, 0x09,
            ],
            // --\r-----\r…-m\n (setext h2 variant)
            &[
                0x2d, 0x2d, 0x0d, 0x2d, 0x2d, 0x2d, 0x2d, 0x2d, 0x0d, 0x2d, 0x2d, 0x2d, 0x2d,
                0x2d, 0x2d, 0x2d, 0x0d, 0x2d, 0x6d, 0x0a, 0xe0, 0x2d, 0x5b, 0x2d, 0x2d, 0x6d,
                0x0d, 0x2d, 0x2d,
            ],
            // *+{\n{\n=\n=\n'=\n=\n' (setext h1 with leading bracket content)
            &[
                0x2a, 0x2b, 0x7b, 0x0a, 0x7b, 0x0a, 0x3d, 0x0a, 0x3d, 0x0a, 0x27, 0x3d, 0x0a,
                0x3d, 0x0a, 0x27,
            ],
            // Mixed setext + ATX with control bytes
            &[
                0x77, 0x26, 0x2a, 0x3a, 0x0a, 0x0a, 0x2d, 0x3a, 0x0a, 0x2d, 0x0a, 0x3d, 0x0d,
                0x2a, 0x87, 0x16, 0x00, 0x0a, 0x5a, 0x5a, 0x5a, 0x5a, 0x4a, 0x5a, 0x78, 0x0a,
                0x3c, 0x5a, 0x5a, 0x5a, 0x5a, 0x5a, 0x32, 0x5a, 0x5a, 0x2d, 0x0a, 0x3d, 0x0d,
            ],
        ];
        for raw in cases {
